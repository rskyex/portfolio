  ...
  conferenceSection: {
    ...
    cards: [
      ...
      },
      {
        ...
        eyebrow: 'ポスター展 · 2026',
        // タイトル確定までこのカードは一時的に非表示。確定したら `hidden` を外し、
        // 下のプレースホルダーのタイトルを更新して再度表示する。
        hidden: true,
        papers: [
          {
