...
export const orbitalJa: OrbitalContent = {
  ...
  overview: {
    heading: '概要',
    paragraphs: [
      'オービタル・リスク・トラッカーは、軌道インフラ全体にわたる対衛星（ASAT）事象、近接運用、GNSSジャミング事案、そして新たに生じつつあるサイバー・宇宙の連関を監視・可視化する。宇宙領域のエスカレーションの力学を読み解くための、構造化された分析の枠組みを提供する。',
      // TODO(i18n-review): security dilemma / weaponised interdependence / governance architecture の訳語要確認
      'ロバート・ジャービスの安全保障のジレンマの枠組みと武器化された相互依存の理論を手がかりに、軌道上のリスク行動を広い戦略分析のなかに位置づける。宇宙安全保障、軍備管理、ガバナンス・アーキテクチャに取り組む研究者・政策アナリスト・学生を支えることを狙いとして設計されている。',
    ],
  },
