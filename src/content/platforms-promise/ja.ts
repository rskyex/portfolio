...
export const promiseJa: PromiseContent = {
  ...
  overview: {
    ...
    paragraphs: [
      ...
      'Japan Promise Tracker は、日本政府の政策コミットメントをガバナンス領域にわたって監視・追跡する。政府の約束のライフサイクル——表明から実施を経て、達成あるいは放棄に至るまで——を追うための構造化された枠組みを提供する。',
      // TODO(i18n-review): public accountability / legitimation / political communication の訳語要確認
      '公的アカウンタビリティ、市民参加、政策分析を支えるよう設計され、本プラットフォームは政府のコミットメントを透明かつ追跡可能にする。ガバナンスにおける約束が、正統化と政治的コミュニケーションの手段としていかに機能するかについての、より広い理解に資する。',
    ],
  },
