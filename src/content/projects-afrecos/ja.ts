...
export const afrecosJa: AfrecosContent = {
  ...
  overview: {
    ...
    paragraphs: [
      'AFRECOSは、アフリカと日本の文化・政策コミュニティをつなぐために設立された、10か国以上にまたがるネットワークである。共同設立者兼代表を務めた小柳璃紗は、組織をゼロから築き上げ、多様な国際メンバーとともに文化交流、政策イベント、市民への働きかけを企画・運営してきた。',
      '主な成果として、約70〜80名が参加するイベントの開催に加え、政府・市民社会・外交関係者から約50名のステークホルダーが集う政策トークを日本の参議院で実施した。',
    ],
  },
