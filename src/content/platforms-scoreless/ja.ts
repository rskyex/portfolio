...
export const scorelessJa: ScorelessContent = {
  ...
  overview: {
    ...
    paragraphs: [
      ...
      'クラシック音楽の構造・論理・意味を、楽譜の読解力を要さずにアクセス可能にする音楽分析プラットフォーム。作品を単に「美しい」「悲しい」と語るのではなく、主題の反復・緊張と弛緩・形式上の展開、そしてそこから立ち現れる知的・美的な含意を、タイムライン、モチーフ表示、解説カードを通じて可視化する。',
      // TODO(i18n-review): public domain / structured thought の訳語要確認
      'おもにパブリックドメインのクラシック作品を扱い、音楽を趣味の問題としてではなく、時間のなかで展開する構造化された思考として捉える。Scoreless は MYTHERA プロジェクトの一部である。',
    ],
  },
