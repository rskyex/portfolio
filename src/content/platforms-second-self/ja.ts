...
export const secondSelfJa: SecondSelfContent = {
  meta: {
    ...
    description:
      'AI・記憶・ガバナンス・主体性の形成を探究するオンラインの哲学カードゲーム。システムが、人間が自己になっていく過程そのものを形づくりはじめるとき、何が起こるのか。',
  },
  ...
  overview: {
    ...
    paragraphs: [
      ...
      'AI・記憶・ガバナンス・主体性の形成をテーマとするオンラインの哲学カードゲーム。アルゴリズム的システムが社会の深層にまで浸透した近未来を舞台に、プレイヤーは相手を打ち負かすのではなく、社会そのものを設計する。',
      // TODO(i18n-review): human subjects / conditions of society / selfhood の訳語要確認
      'プレイヤーは情報環境を構築し、記憶の制度を整え、公共空間とガバナンス構造を選び取る。そうすることで、いかなる人間主体が立ち現れるかが決まる。カードを切ることは、単に力を行使することではない。それは社会の条件を書き換え、自己性が成り立つまさにその前提を変える行為である。',
      // TODO(i18n-review): govern human behaviour / become selves の訳語要確認
      'ゲームの核心には、次の問いがある。システムが、もはや人間の行動を統治するにとどまらず、人間が自己になっていくまさにその過程に参与しはじめるとき、何が起こるのか。',
    ],
  },
  cardSystem: {
    heading: 'カードシステム',
  ...
  victory: {
    ...
    paragraphs: [
      ...
      '勝利は、相手のHPを削り切ることでは得られない。プレイヤーは、安定・自由・正統性・革新・心理的統合・民主的能力・記憶の多様性といった複数の指標にまたがる緊張を御していかなければならない。',
      // TODO(i18n-review): strongest board / what kind of human being の訳語要確認
      '「勝つ」とは、最も強い盤面を築くことではない。それは、あなたがいかなる社会を築き、その結果としていかなる人間を生み出したかの評価にほかならない。',
    ],
  },
