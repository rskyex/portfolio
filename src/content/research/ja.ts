...
export const researchJa: ResearchContent = {
  ...
  intro:
    '国際安全保障、宇宙ガバナンス、核ガバナンス、サイバーガバナンス、先端技術ガバナンスを横断する研究。正統化理論、デュアルユース・ガバナンス、権威アーキテクチャ、責任ある行動規範を概念的な焦点とする。',
  workingPaper: {
    heading: 'ワーキングペーパー',
    items: [
      {
        ...
        description:
          '概念的なフラッグシップ。競合する月面ガバナンスの枠組み——アルテミス合意と国際月面研究ステーション（ILRS）計画——が、いかにして正統化の受け手を構築し、翻訳装置を用い、普遍主義的な言説のもとで権威アーキテクチャを築きながら、相異なる参加条件と境界形成の実践を確立していくのかを検討する。',
      },
    ],
  },
  inProgress: {
    ...
    items: [
      {
        ...
        description:
          '「責任ある行動」が、宇宙・AI・サイバーの各ガバナンスにおいて未完の規範としていかに機能するかを検討する——デュアルユース技術をめぐるガバナンス言説における否認・転位・予防接種の力学を分析する。',
      },
      {
        ...
        description:
          '福島での6年間にわたるフィールドワークに基づき、本研究は災害後の復興のガバナンスを検討する——信頼、透明性、政策の空隙、そして国家機関と被災コミュニティとの間で変化し続ける関係に焦点を当てる。',
      },
    ],
  },
  conferenceDev: {
    ...
    items: [
      {
        ...
        description:
          '存在論的ガバナンスを、AIシステムが「何をするか」だけでなく、ガバナンスが守るべき尊厳と主体性をもつ——知り、存在し、自らを統治する——人間に「何をするか」を問う二次的な分析層として提示する。',
      },
    ],
    cards: [
      {
        ...
        description:
          'デュアルユースの曖昧性が、核・宇宙・サイバーの各領域においてガバナンスの枠組みをいかに形づくるかを探究する——民生と軍事の用途を同時に持つ技術を規制することの構造的な困難を検討する。',
      },
      {
        ...
        description:
          '先端技術ガバナンスにおいて、権威がいかに構築され、配分され、争われるのかを理解するための枠組みを構築する——正統化のプロセス、制度設計、そして技術的専門知の役割に着目する。',
      },
    ],
  },
  presentations: {
