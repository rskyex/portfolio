...
export const ontologicalGovernanceJa: OntologicalGovernanceContent = {
  ...
  overview: {
    ...
    paragraphs: [
      ...
      'EU AI法や、生まれつつある多国間の枠組みを含め、現在のAIガバナンスの枠組みは共通のアーキテクチャを備えている。すなわち、技術を特定し、その危害を評価し、それに応じて規則を構築するというものである。こうした計算の中心に置かれる人間という主体は、安定した所与として扱われてきた。だが、その前提はもはや成り立たない。',
      ...
      'AIシステムは今や、人間存在を成り立たせる累積的な三つの層にわたって介入している。認識論的には、人々が何を知りうるかを形づくる。アルゴリズムによるキュレーションが、本人の気づきだけでは元に戻せない仕方で情報環境を構築するのである。存在論的には、人々が何者であるかに介入する。推薦システムやパーソナライズされた環境が、個人が時間をかけて自らのアイデンティティと記憶を編んでいくためのナラティブの素材を作り変える。政治的には、真の自己統治の条件を蝕む。民主的熟議に参加する主体そのものが、まさにガバナンスの監督対象であるはずのシステムによってますます構成されていくからである。',
      ...
      'ナラティブ・アイデンティティの諸理論と記憶の技術に依拠し、本発表は存在論的ガバナンスを提示する。すなわち、AIシステムが「何をするか」だけでなく、知り、存在し、自らを統治する人間、つまりガバナンスがまさに守るために存在する尊厳と主体性をもつ人間に「何をするか」を問う、二次的な分析層である。この層を欠くならば、現在の枠組みは、技術がすでに作り変えつつある或る種の「人間」を保護してしまう危険を負う。',
    ],
  },
  ...
  keyQuestions: {
    ...
    items: [
      ...
      '二次的なガバナンスの枠組み、すなわちAIシステムだけでなく、それがガバナンスそのものの対象である主体に及ぼす影響をも統治する枠組みとは、いかなるものか。',
