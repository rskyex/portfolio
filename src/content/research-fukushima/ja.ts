...
export const fukushimaJa: FukushimaContent = {
  ...
  overview: {
    ...
    paragraphs: [
      ...
      '福島地域における6年間にわたるフィールドワークに依拠し、災害後の復興のガバナンスを検討する。着目するのは、公式の政策枠組みと被災コミュニティの生きられた経験との間に持続する乖離であり、とりわけ信頼、透明性、長期的な制度的アカウンタビリティをめぐる問題である。',
      // TODO(i18n-review): state-society relations / institutional legitimacy（glossary: legitimacy, review）要確認
      '避難者、自治体の首長、経済産業省（METI）および東京電力（TEPCO）の関係者へのインタビューを通じて、長期化する避難、不確実な情報、争われる復興のナラティブという圧力のもとで国家と社会の関係がいかに変容するのかをたどる。本研究は、災害ガバナンス、制度的正統性、復興の政治をめぐるより広範な議論に寄与する。',
    ],
  },
