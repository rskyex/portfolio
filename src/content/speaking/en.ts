...
export const speakingEn: SpeakingContent = {
  header: {
    kanji: '演',
  ...
  events: [
    ...
    },
    {
      ...
      description:
        'Engagement in a high-level roundtable on education policy hosted by the Global Partnership for Education and the World Bank, convened at the Japanese House of Councillors.',
