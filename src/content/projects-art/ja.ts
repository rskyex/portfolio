...
export const artJa: ArtContent = {
  ...
  overview: {
    ...
    paragraphs: [
      'ビジュアル・シンキングを、ガバナンス・アイデンティティ・技術をめぐる広範な研究関心とつなぐ学際的なアート活動。この作品群は、研究テーマと並行し、それに示唆を与える、表象・物質性・概念的な枠づけの問いに取り組む。',
      'この活動は、ビジュアルアート、概念的な作品、そして展示にわたり、より広範なポートフォリオと同じく異文化・学際的な志向を反映した国際的な展示歴を持つ。ここでアートは、独立した領域としてではなく、同じ構造的な問い——権威、正統性、表象、そして意味のアーキテクチャ——を考えるための別の思考様式として機能する。',
    ],
  },
  exhibitionHistory: {
    heading: '展示歴',
