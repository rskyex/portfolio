...
export const nuclearJa: NuclearContent = {
  ...
  overview: {
    heading: '概要',
    paragraphs: [
      'グローバル原子力インフラ・アトラスは、稼働中の原子炉、廃炉施設、主要な事故サイトを含む、世界の民生用原子力発電インフラのインタラクティブなマッピング・インターフェースを提供する。原子力インフラを、推定核戦力データや放射線・健康の枠組みのなかで文脈づける。',
      // TODO(i18n-review): 国際機関名（IAEA/SIPRI/WHO）の日本語正式表記要確認
      '教育および政策の場での利用を想定し、本プラットフォームは国際原子力機関（IAEA）、ストックホルム国際平和研究所（SIPRI）、世界保健機関（WHO）などの公開データに基づいている。原子力インフラの地理的分布と、それに伴うガバナンス上の課題について、市民の理解を深めることを目的としている。',
    ],
  },
