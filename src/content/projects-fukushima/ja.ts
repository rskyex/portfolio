...
export const fukushimaJa: FukushimaContent = {
  ...
  overview: {
    ...
    paragraphs: [
      '2019年から2024年にかけて、福島県の双葉地区および浪江地区で実施した複数拠点でのフィールドワーク。本研究は災害後ガバナンスを検討し、公式の復興政策と避難を強いられたコミュニティの生活実態との間に根強く残るギャップに焦点を当てる。',
      '6年以上にわたる関与のなかで、本フィールドワークは避難者、自治体の首長、町のリーダー、経済産業省（METI）の職員、そして東京電力（TEPCO）の関係者へのインタビューを重ねてきた。長期にわたる避難と不確かな情報という状況のもとで変化し続ける、信頼・透明性・制度的なアカウンタビリティの力学をたどる。',
    ],
  },
  researchOutputs: {
    heading: '研究成果 — 成果',
    intro:
      '福島県における6年間のフィールドワーク、ステークホルダーとの関与、そして分野横断的な対話を通じて構築された主要な知見と分析枠組み。',
    items: [
      {
        n: 1,
        ...
        title: '事故と、それが残したもの',
        description:
          '2011年3月11日の災害と、その長く続く影響の時系列——15万4千人の避難、数十年にわたる除染、分断されたガバナンス、そしてコミュニティへのスティグマ。',
      },
      {
        n: 2,
        title: 'ステークホルダー・マッピング',
        description:
          '政府、東京電力（TEPCO）・産業界、新エネルギー事業者、市民社会にわたるアクターの包括的なマッピング——それぞれが「復興」について異なる定義を持つ。',
      },
      {
        n: 3,
        title: '競合する利害と対立の軸',
        description:
          '相対立する利害の分析——洋上風力をめぐって割れる漁業協同組合、規模か生業かをめぐる経済産業省（METI）対町の首長、そして政府とコミュニティの間の信頼のギャップ。',
      },
      {
        n: 4,
        title: '研究の独立性とアクセス',
        ...
        description:
          'あらゆるステークホルダー集団との信頼に基づくアクセスを築くための方法論的枠組み——相手に応じて、技術的なものから感情的なもの、政策的なものへと言葉を使い分ける。',
      },
      {
        n: 5,
        title: '初訪問から論文発表まで',
        ...
        description:
          '共感から検証・反復に至るデザイン思考のプロセス——現場への没入、問題の再定義、分野横断的な対話のプロトタイプ、そしてステークホルダーとのフィードバック・ループ。',
      },
    ],
  },
