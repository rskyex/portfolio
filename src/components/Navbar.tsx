  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-indigo-950/95 backdrop-blur-sm border-b border-vermillion/15">
      <div className="asanoha-bg">
        ...
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-vermillion/40 via-vermillion/70 to-gold/40" />
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="hidden sm:inline font-noto-sans text-xs text-washi/50 tracking-widest uppercase">
              Risa Koyanagi
            </span>
          </Link>
      ...
      {/* Mobile menu */}
      {isOpen && (
        <div className="md:hidden bg-indigo-950/98 border-t border-vermillion/10 sayagata-bg">
