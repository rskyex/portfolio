  ...
  return (
    <footer className="relative bg-kuro border-t border-kin/[0.04]">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-16">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <span className="block font-noto-sans text-[10px] text-shiro/20 tracking-[0.3em] uppercase mt-0.5">
                Risa Koyanagi
              </span>
            </div>
          </div>
          ...
          <nav className="flex flex-wrap justify-center gap-6">
            {['Platforms', 'Research', 'Projects', 'Speaking', 'About'].map(item => (
              <Link
                ...
                className="font-noto-sans text-xs text-shiro/20 hover:text-kin/60 transition-colors tracking-wider uppercase"
              >
                {item}
              </Link>
            ))}
          ...
          <div className="flex flex-col items-center md:items-end gap-1.5">
            <a
              ...
              className="font-noto-sans text-xs text-shiro/20 hover:text-tsubaki-blush/60 transition-colors"
            >
              risakyng@gmail.com
            </a>
            <a
        ...
        <p className="font-noto-sans text-[10px] text-shiro/10 text-center tracking-widest uppercase">
