  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 md:py-20">
      ...
      <div className="mt-4 mb-8">
        <span className="px-2 py-0.5 text-xs font-noto-sans rounded-sm border bg-shiro/[0.03] text-shiro/30 border-shiro/[0.06]">
          In Progress
        </span>
      </div>
        ...
        <div className="panel rounded-sm p-8">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <p className="font-noto-sans text-sm text-shiro/40">Multi-site fieldwork across Futaba and Namie districts (2019–2024)</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="font-kaisei text-lg text-kin/50">二</span>
              <p className="font-noto-sans text-sm text-shiro/40">Interviews with evacuees, mayors, town leaders, METI officials, and TEPCO representatives</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="font-kaisei text-lg text-kin/50">三</span>
              <p className="font-noto-sans text-sm text-shiro/40">Organised 11-person study tour to affected areas</p>
            </div>
          </div>
        </div>
