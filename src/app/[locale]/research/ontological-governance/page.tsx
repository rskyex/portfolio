...
import { getOntologicalGovernanceContent } from '@/content/research-ontological-governance';

export function generateMetadata(): Metadata {
  return { alternates: buildAlternates('/research/ontological-governance') };
}

export default async function OntologicalGovernancePage({
  params,
}: {
  ...
  const c = getOntologicalGovernanceContent(locale as Locale);
