...
import { getScorelessContent } from '@/content/platforms-scoreless';

export function generateMetadata(): Metadata {
  return { alternates: buildAlternates('/platforms/scoreless') };
}

export default async function ScorelessPlatformPage({
  params,
}: {
  ...
  const c = getScorelessContent(locale as Locale);
