...
import { getFaultlineContent } from '@/content/platforms-faultline';

export function generateMetadata(): Metadata {
  return { alternates: buildAlternates('/platforms/faultline') };
}

export default async function FaultlinePlatformPage({
  params,
}: {
  ...
  const c = getFaultlineContent(locale as Locale);
