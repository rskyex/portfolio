...
import { getNuclearContent } from '@/content/platforms-nuclear';

export function generateMetadata(): Metadata {
  return { alternates: buildAlternates('/platforms/nuclear') };
}

export default async function NuclearPlatformPage({
  params,
}: {
  ...
  const c = getNuclearContent(locale as Locale);
