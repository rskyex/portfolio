...
import { getPromiseContent } from '@/content/platforms-promise';

export function generateMetadata(): Metadata {
  return { alternates: buildAlternates('/platforms/promise') };
}

export default async function PromisePlatformPage({
  params,
}: {
  ...
  const c = getPromiseContent(locale as Locale);
