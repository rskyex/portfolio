...
import { getNarrativeDriftContent } from '@/content/platforms-narrative-drift';

export function generateMetadata(): Metadata {
  return { alternates: buildAlternates('/platforms/narrative-drift') };
}

export default async function NarrativeDriftPlatformPage({
  params,
}: {
  ...
  const c = getNarrativeDriftContent(locale as Locale);
