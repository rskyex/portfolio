...
import { getOrbitalContent } from '@/content/platforms-orbital';

export function generateMetadata(): Metadata {
  return { alternates: buildAlternates('/platforms/orbital') };
}

export default async function OrbitalPlatformPage({
  params,
}: {
  ...
  const c = getOrbitalContent(locale as Locale);
