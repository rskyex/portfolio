...
import { getSelfTraceContent } from '@/content/platforms-selftrace';

export function generateMetadata(): Metadata {
  return { alternates: buildAlternates('/platforms/selftrace') };
}

export default async function SelfTracePlatformPage({
  params,
}: {
  ...
  const c = getSelfTraceContent(locale as Locale);
