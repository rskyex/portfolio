...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="overflow-x-hidden">
      ...
      <body className="font-inter antialiased bg-[#f7f2e9] text-shiro overflow-x-hidden">
        <LocaleHtmlLang />
        {/* Global page background — warm ivory washi behind all pages */}
        <div className="fixed inset-0 -z-10 bg-[#f7f2e9]" />
        <Navbar />
