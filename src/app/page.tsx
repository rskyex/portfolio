            ...
            <div>
              ...
              <div className="max-w-xl mb-8 rounded-lg bg-kuro/20 backdrop-blur-[2px] px-5 py-4">
                ...
                <p className="font-inter text-sm text-shiro/75 leading-[1.9] mt-3">
                  She will read <strong className="font-semibold text-shiro/90">Human, Social, and Political Sciences</strong> at <strong className="font-semibold text-shiro/90">Hughes Hall, University of Cambridge</strong> from <strong className="font-semibold text-shiro/90">Oct 2026–</strong>.
                </p>
              </div>
