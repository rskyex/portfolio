            ...
            <div>
              ...
              <div className="max-w-xl mb-8 rounded-lg bg-kuro/20 backdrop-blur-[2px] px-5 py-4">
                ...
                <p className="font-inter text-sm text-shiro/75 leading-[1.9] mt-3">
                  She will read <strong className="font-semibold text-shiro/90">Human, Social, and Political Sciences</strong> at <strong className="font-semibold text-shiro/90">Hughes Hall, University of Cambridge</strong>, matriculating <strong className="font-semibold text-shiro/90">Michaelmas Term 2026</strong>.
                </p>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20 relative">
        ...
        <div className="relative">
          ...
          <div className="mt-12 mb-2">
            <h3 className="font-inter text-[10px] text-shiro/70 tracking-[0.25em] uppercase font-semibold">Speaking & Policy Engagement</h3>
          </div>
